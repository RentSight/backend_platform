...
namespace Rent_Sight.API.Controllers.Analytics
{
    ...
    public class AvailabiltyByNeighbourhoodTest : ControllerBase
    {
        ...
        [HttpGet("summary")]
        public ActionResult<AvailabilitySummaryResponseDTO> SummaryAvalability()
        {
            var data = new AvailabilitySummaryResponseDTO
            {
                Meta =
                {
                    GeneratedAt = DateTimeOffset.UtcNow,
                    Filters = { RoomType = null, MinListings = 10 }
                }
            };
